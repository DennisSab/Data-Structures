...
struct new_movie * New_movie;
struct new_movie * Categories[6];
struct new_movie * lastUsed[6];
struct new_movie * tempCategoty1;
struct new_movie * tempCategoty2;
...
struct suggested_movie* mergedList;
struct suggested_movie* sugMovie;
struct suggested_movie* mergedListHead;
struct suggested_movie* mergedListTail;
struct suggested_movie* currentHead;
struct suggested_movie* currentTail;

    
int addFilterListUser;
 ...
 * Print Categories
 * 
 * @param the head of each category array
 */
...
/**
 * @brief Prints the new movie list
